...
def parse_wdimacs_file_ex2(filename: str):
    ...
    with open(filename, 'r') as file:
        for line in file:
            ...
            tokens=list(map(int, line.split()))    # the clause line
            clause_lits=tokens[1:-1]               # skip the first 0 and last 0
...
def evaluate_fitness(population, clauses, m):
    ...
    for individual in population:
        ...
        cost=m-nsat  # the smaller the cost, the better
...
def run_memetic_bga(n, m, clauses, pop_size, mutation_rate, time_budget, selection_rate):
    ...
    best_individual, best_nsat_value, best_fitness_value=find_best_solution(population, fitness_scores, nsat_list)
